...
namespace InvoiceManagement.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public IActionResult CreateInvoice([FromBody] InvoiceRequest invoices)
        {
            try
            {
                var identity = User.Identity as ClaimsIdentity;
                ...
                var user_ = invoice_.BindInvoice(invoices);
                if (user_.Result == "500")
                {
        ...
        public async Task<IActionResult> GetInvoiceItemDetails([FromBody] List<int?> invoice_No)
        {
            try
            {
                ...
                DateTime invoicedate = pDFTemplate[0].companyDetails.customerdetails[0].itemDetails[0].invocieDate;

                string formattedDate = invoicedate.ToString("MM/dd/yyyy");
                ...
                htmlContent += "<p>Invoice Date : " + formattedDate + "</p>";
                htmlContent += "</div>";
                htmlContent += "</div>";
                ...
                foreach (var customer in pDFTemplate[0].companyDetails.customerdetails)
                {
                    foreach (var item in customer.itemDetails)
                    {
                        ...
                        htmlContent += "<td style='padding: 20px; width:15%; text-align: left; border-bottom: 1px solid #ddd;'>Rs. " + item.price + "</td>";
                        htmlContent += "<td style='padding: 20px; width:15%; text-align: left; border-bottom: 1px solid #ddd;'>Rs. " + " " + item.Amount + "</td>";
                        htmlContent += "</tr>";
                    }
                }
                subtotal = pDFTemplate[0].companyDetails.customerdetails[0].itemDetails[0].subtotalAmt;
                gstRate = pDFTemplate[0].companyDetails.customerdetails[0].itemDetails[0].gstRate;
                gstamt = Math.Truncate(100 * (subtotal * gstRate / 100)/100??0);
                net_totalAmount = pDFTemplate[0].companyDetails.customerdetails[0].itemDetails[0].netAmount;
                ...
                htmlContent += "<td  style = 'padding: 20px; font-weight: bold;'></td>";
                htmlContent += "<td  style = 'padding: 20px; font-weight: bold;'>Sub Total Amount :</td>";
                htmlContent += "<td colspan='4' style = 'padding: 20px;width:100%; float:right; border-top: 1px solid #ddd; font-weight: bold;' > Rs. " + subtotal + "</td>";
                htmlContent += "</tr>";
                ...
                htmlContent += "<td  style = 'padding: 20px; font-weight: bold;'></td>";
                htmlContent += "<td  style = 'padding: 20px; font-weight: bold;'></td>";
                htmlContent += "<td  style = 'padding: 20px; font-weight: bold;'>GST Rate :</td>";
                htmlContent += "<td colspan='4' style = 'padding: 20px;width:100%; float:right; border-top: 1px solid #ddd;' >" + gstRate + "%" + "</td>";
                htmlContent += "</tr>";

                htmlContent += "<tr>";
                htmlContent += "<td  style = 'padding: 20px; font-weight: bold;'></td>";
                htmlContent += "<td  style = 'padding: 20px; font-weight: bold;'></td>";
                htmlContent += "<td  style = 'padding: 20px; font-weight: bold;'>GST Amount :</td>";
                htmlContent += "<td colspan='4' style = 'padding: 20px;width:100%; float:right; border-top: 1px solid #ddd;' > Rs. " + gstamt + "</td>";
                htmlContent += "</tr>";

                htmlContent += "<tr>";
                htmlContent += "<td  style = 'padding: 20px; font-weight: bold;'></td>";
                htmlContent += "<td  style = 'padding: 20px; font-weight: bold;'></td>";
                htmlContent += "<td  style = 'padding: 20px; font-weight: bold;'>Net Amount :</td>";
